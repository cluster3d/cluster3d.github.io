...
from utils import transform_pc
...
def get_train_dataset(p, transform, to_augmented_dataset=False,
    ...
    # Base dataset
    if p['train_db_name'] == 'abc2':
        from data.abc2 import ABC2
        dataset = ABC2(train=True, transform=transform)  
...
def get_val_dataset(p, transform=None, to_neighbors_dataset=False):
    ...
    if p['train_db_name'] == 'abc2':
        from data.abc2 import ABC2
        dataset = ABC2(train=False, transform=transform)    
...
#         transform_pc.ShufflePoints(),
#         transform_pc.Rotate(),
        transform_pc.RotatePerturbPC(),
        transform_pc.Jitter(),
#         transform_pc.RandomScale(),
#         transform_pc.RandomPointDropout(),
        transform_pc.ToTensor(),
        transform_pc.Normalize()
    ])    
...
#             transform_pc.ShufflePoints(),
#             transform_pc.Rotate(),
#             transform_pc.RotatePerturbPCWithNormal(),
#             transform_pc.Jitter(),
#             transform_pc.RandomScale(),
#             transform_pc.RandomPointDropout(),
#             transform_pc.ToTensor(),
