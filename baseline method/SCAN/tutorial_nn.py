...
sys.path.append('/data2/ABC2/')
sys.path.append('/data2/ABC2/pt-dec/')
...
#     model = model.cuda()
    ...
    cuda=True
    model = PointNet(nlatent=bottleneck_size)
    model.cuda()
    
    checkpoint = torch.load("../bkp_AtlasNet/logs/atlasnet_bottleneck_size_{}/encoder.pth".format(bottleneck_size))
