...
import dataset.dataset_abc2 as dataset_abc2
...
#         self.datasets.dataset_test = dataset_shapenet.ShapeNet(self.opt, train=False)
        ...
        self.datasets.dataset_train =  dataset_abc2.ABC2Dataset_pc("/data2/ABC2/data_raw_clustering/pc_correct_num", train=True)
        self.datasets.dataset_test = dataset_abc2.ABC2Dataset_pc("/data2/ABC2/data_raw_clustering/pc_correct_num", train=False)
