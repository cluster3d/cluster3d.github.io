...
class TrainerAbstract(object):
    ...
    def get_log_paths(self):
        ...
        self.opt.encoder_model_path = join(self.opt.dir_name, "encoder.pth")
    ...
    def save_network(self):
        ...
        print("network saved, saving encoder..")
        torch.save(self.network.module.encoder.state_dict(), self.opt.encoder_model_path)
