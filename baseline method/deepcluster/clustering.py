...
def pc_loader(path):
    ...
    """
#     print(path)    
    return norm_pc(torch.load(path))
...
#         print("images:", images)
        ...
        print("image_indexes number:", len(image_indexes))
        print("pseudolabels number:", len(pseudolabels))
...
class Kmeans(object):
    ...
    def cluster(self, data, model_ids, verbose=False):
        ...
        self.model_id_lists = [[] for i in range(self.k)]
        for i in range(len(data)):
            self.images_lists[I[i]].append(i)
            self.model_id_lists[I[i]].append(model_ids[i])
